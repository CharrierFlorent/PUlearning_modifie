...
def new_dict_generation(mutils, dp, dutils, flag, word_predict, dataset, iteration, num, unlabeled=0):
    if flag == "PER":
        name = "person.txt"
    elif flag == "LOC":
        name = "location.txt"
    ...
    if unlabeled:
        ...
        newDicFile = "dictionary/" + dataset + "/" + str(iteration) + "_" + name + "_" + num
    ...
    if unlabeled:
        ...
        dp.writeFile("data/" + dataset + "/" + num + "_" + "train." + flag + str(iteration) + ".txt", "TRAIN", flag, oriSentences)
...
if __name__ == "__main__":
    ...
    new_dict_generation(mutils, dp, dutils, args.flag, word_predict, args.dataset, args.iter, args.num, args.unlabeled)
